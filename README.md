...
- **Any LLM brain** — Anthropic, OpenAI, or a self-hosted OpenAI-compatible model, chosen entirely by config
...
| VAD | Silero |
| LLM | Anthropic / OpenAI / self-hosted (OpenAI-compatible), via a Provider Factory |
